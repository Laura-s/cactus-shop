<template>
  <svg preserveAspectRatio="xMidYMid meet" data-bbox="10.326 50.3 180.129 101.208" xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="10.326 50.3 180.129 101.208" role="img">
    <g>
